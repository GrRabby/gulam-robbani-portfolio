...
export default function Cursor() {
  ...
  useEffect(() => {
    ...
    const xDot = gsap.quickTo(dot, 'x', { duration: 0.00001, ease: 'power3.out' });
    const yDot = gsap.quickTo(dot, 'y', { duration: 0.00001, ease: 'power3.out' });
    const xRing = gsap.quickTo(ring, 'x', { duration: 0.1, ease: 'power3.out' });
    const yRing = gsap.quickTo(ring, 'y', { duration: 0.1, ease: 'power3.out' });
